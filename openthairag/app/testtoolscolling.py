...
openai.api_base = "https://api.runpod.ai/v2/vllm-shpfg8sykd85hh/runsync"
openai.api_key = "rpa_O03221UQ789R0PIN6F12XPJ72QCQ3SJJVXSA1GJW13n59b"  # vLLM doesn't require a real API key
...
while True:
    try:
        ...
        response = openai.ChatCompletion.create(
            model="openthaigpt/openthaigpt1.5-7b-instruct",  # Specify the model you're using with vLLM
            messages=messages,
            tools=tools,
            temperature=0.7,
            top_p=0.8,
...
if assistant_message and assistant_message.get("content"):
    ...
    print("No valid assistant message generated.")